...
- **Domain tab grouping**: when a tab navigates to a site, it is placed in a native Chrome tab group labeled and colored by domain. If same-domain tabs already exist in another window, those tabs move into the navigating tab's window. Toggle in settings.
